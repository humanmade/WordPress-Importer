...
class WXR_Import_Command extends WP_CLI_Command {
	 ...
	 * Import content from a WXR file.
	 *
	 * This is included for comparison purposes. This will be removed before
	 * final release.
	 *
	 * TODO: remove this ;)
	 *
	 ...
	 * : Path to one or more valid WXR files for importing. Directories are also accepted.
	 */
	public function old( $args ) {
		$import_command = new Import_Command();
		$import_command( $args, array( 'authors' => 'create' ) );
		var_dump( size_format( memory_get_peak_usage(), 4 ) );
	}
}

if ( ! class_exists( 'Import_Command' ) ):
