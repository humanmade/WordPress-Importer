<?php
abstract class WXR_Import_UnitTestCase extends WP_UnitTestCase {
	...
	protected function _import_wp( $filename, $users = array(), $fetch_files = true ) {
		...
		// @todo there needs to be a logger in case of errors
		//		 by this CLI logger doesn't seem to produce any output when
		//		 when from phpunit.  Maybe there should be a phpunit-specific logger?
